        ...
        $.ajax({
            ...
            statusCode: {
                500: function(response) {
                    console.log(response)
                    Toastify({
                        text: 'Partner edit unsuccessful',
                        backgroundColor: '#d74d4d',
                    }).showToast();
                    $('#btn-loader').addClass('d-none')
                    $('#btn-action').removeClass('d-none')
        ...
        $.ajax({
            ...
            statusCode: {
                500: function(response) {
                    console.log(response)
                    Toastify({
                        text: 'Partner delete unsuccessful',
                        backgroundColor: '#d74d4d',
                    }).showToast();
                    $('#btn-loader').addClass('d-none')
                    $('#btn-action').removeClass('d-none')
            ...
            success: function(data) {
                $("#form-data")[0].reset()
                Toastify({
                    text: 'Partner delete successful',
                    backgroundColor: '#435ebe',
                }).showToast();
                $('#btn-loader').addClass('d-none')
                table.ajax.reload()
